...
// 1) showRGB() displays a single color on the RGB LED:
//   - You call showRGB() with the number of a color you want
//     to display

// 2) showSpectrum() steps through all the colors of the RGB LED,
...
// Function for show all spectrum colors:
...
void showSpectrum() {
  // Define an integer variable called "x"
  int x;  
...
// Function for show the RGB colors:
